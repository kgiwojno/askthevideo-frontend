...
const AppSidebar = ({
  ...
  return (
    <aside className="w-[300px] min-w-[300px] h-full bg-card border-r border-border flex flex-col overflow-hidden max-md:w-full max-md:h-full max-md:min-w-0 max-md:border-r-0">
      {/* Logo */}
